...
function stopDefAction(t){t.preventDefault(),ga("send","event","Tour pages","Book Now Button Clicked",document.URL)}try{document.getElementById("BookNow").addEventListener("click",stopDefAction,!1),document.getElementById("BookNow1").addEventListener("click",stopDefAction,!1);var tour=document.getElementsByClassName("wc-bookings-booking-form"),tourID=tour[0].dataset.tourid,button=new TrekkSoft.Embed.Button;button.setAttrib("target","fancy").setAttrib("entryPoint","tour").setAttrib("tourId",tourID).setAttrib("referral","INSIDERLONDONLTD").registerOnClick("#BookNow");var button2=new TrekkSoft.Embed.Button;button2.setAttrib("target","fancy").setAttrib("entryPoint","tour").setAttrib("tourId",tourID).setAttrib("referral","INSIDERLONDONLTD").registerOnClick("#BookNow1")}catch(t){console.log(t)}var jt=jt||{};jt.nav=function(){function t(){document.getElementById("dt-menu-toggle").addEventListener("click",function(t){t.preventDefault();var e=document.getElementById("menu-main-menu");"none"==e.style.display||""==e.style.display?e.style.display="block":e.style.display="none"})}return{mobileMenu:t}}(),jt.nav.mobileMenu();var slideshow=document.querySelector("#slideshow");imagesLoaded(slideshow,function(){var t=document.querySelector(".js_slider");t&&(slider=lory(t,{rewind:!0,infinite:1,ease:"easeInOutElastic"}),setInterval(function(){slider.next()},3300))});